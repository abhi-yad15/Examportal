              ...
              <div class="col-md-8 col-md-offset-2">
               <h1 style="font-size:40px;font-weight:bold; color:blue;">Instructions</h1>
                  <ul>
                      ...
                      <li>Each question will consist an image that will be displayed only for <b>15 seconds</b> - The 3 sub questions will be based on the image shown.<br/></li>
                      <li>Each question will carry <b>4</b> marks.<br/></li>
                  </ul>  
                 <a class="btn btn-primary" href="time.php">Question 1</a>
                 <a class="btn btn-primary" href="time1.php">Question 2</a>  
              </div>      
          </div> 
          <?php 
           }
