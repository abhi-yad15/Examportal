...
<div class="container">
      ...
      <div class="masthead">
        <nav>
          <ul class="nav nav-justified">
            ...
            <li class="active"><a href="level3.php">Level3:</a></li>
    ...
    <div class="container-fluid">
	  ...
	  <?php
	      ...
	      $query = "SELECT * FROM details WHERE level='level3'"; 	 
