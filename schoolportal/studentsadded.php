...
<div class="wrap">
  ...
  <div class="container">
    ...
    <section id="content">
      <div class="inside">
          <table><tr><th>SNo.</th><th style="min-width:200px;">Student's Name</th><th style="min-width:80px;">Level</th><th style="min-width:250px;">Email</th>
   </tr>
              <?php 
              $count=1;
              while($row2 = mysqli_fetch_array($result2,MYSQLI_ASSOC)){?>
                  <tr><td><?php echo $count; ?></td><td><?php echo $row2['name'];?></td><td><?php echo $row2['level'];?></td><td><?php echo $row2['email']; ?></td></tr>
                <?php  $count++;
              }?>
          </table>
          <br /><br />
