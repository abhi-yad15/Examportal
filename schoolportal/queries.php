...
$result2=mysqli_query($conn,"SELECT * FROM school_query where username='$login_session'");
  ...
  <div class="container">
    ...
    <section id="content">
      <div class="inside">
          ...
          <div><a style="text-decoration:none;" href="contact-us.php" class="btn btn-primary">Ask Query</a><br>&nbsp;</div>
          <h2>Your Queries:</h2><br />
               <div class="margin" style="text-align:left">
                   ...
                   while($row2 = mysqli_fetch_array($result2,MYSQLI_ASSOC)){
                       ...
                       $str= "q". $count;
                   ?>
                <li> <input id="<?php echo $total; ?>" type='submit' name='<?php echo $str; ?>' style="text-align:left;color:navy;" class="btn btn-block" value='<?php echo $row2['sub']; ?>' onClick="Display1(this.name,this.id)">
                <li id="<?php echo $str; ?>" class="inv"><b>Message:&nbsp;</b><?php echo $row2['description']; ?><br><br>
                  <b>Answer:&nbsp;</b><?php echo $row2['answer']; ?> </li> 
                   <?php } ?>
            </div>
      </div>
    </section>
