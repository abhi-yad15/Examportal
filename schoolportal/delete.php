...
$result2=mysqli_query($conn,"SELECT * FROM entries WHERE schoolname='{$row1['name']}'");
...
<div class="wrap">
  ...
  <div class="container">
    <aside>
      ...
      <ul class="categories">
        ...
        <li><span><a onclick="Display()">Downloads</a></span>
            <ul class="inv" id="download"><li><span><a href="images/INTERNATIONAL_SCIENCE_AND_CREATIVITY_OLYMPIAD.pdf">Poster</a></span></li>
    ...
    <section id="content">
      <div class="inside">
          <table><tr><th>SNo.</th><th style="min-width:200px;">Student's Name</th><th style="min-width:80px;">Level</th><th style="min-width:250px;">Delete</th>
   </tr>
              <?php 
              $count=1;
              while($row2 = mysqli_fetch_array($result2,MYSQLI_ASSOC)){
                   $temp1=$row2['username'];?>
                  <tr><td><?php echo $count; ?></td><td><?php echo $row2['name'];?></td><td><?php echo $row2['level'];?></td><td> <a href="javascript:AlertIt('<?php echo $temp1;?>')">Delete</a></td>
	  	  
		  <script type="text/javascript">
           function AlertIt(temp1) {
		   var val = temp1;
           //document.write(val);			
           var answer = confirm ("The Student will be Deleted. Do you want to proceed?")
		   
           if (answer){
              window.location="delete1.php?name="+val;
		   }
          }
         </script></tr>
                <?php  $count++;
