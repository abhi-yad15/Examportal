...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $result2= mysqli_query($conn,"UPDATE school_entries SET teachername='$name', teacheremail='$email', teacherphone1='$phone1', teacherphone2='$phone2' WHERE username='$login_session'");
    if($result2)
    {
        header("Location: details.php");
    }
    else 
        $error="Records could not be updated! please try again later.";
}
...
<div class="wrap">
  ...
  <div class="container">
    ...
    <section id="content">
        <div class="inside"><h2>Teacher's Details</h2>
            <span>Enter the details of any Teacher for contact.</span><br/><br/>
            <div class="alert alert-error"><?php echo $error; ?></div>
        <form class="form" method="post" action="" enctype="multipart/form-data">
            <label for="name" >Teacher's Name:</label>
            <input class="form-control" type="text" name="name" value="<?php echo $row1['teachername'] ?>" required>
            <label for="email" >Teacher's Email:</label>
            <input class="form-control" type="email" name="email" value="<?php echo $row1['teacheremail'] ?>" required>
            <label for="contact" >Contact:</label>
            <input class="form-control" type="text" name="phone1" value="<?php echo $row1['teacherphone1'] ?>" required>
            <label for="contact" >Alternate Contact:</label>
            <input class="form-control" type="text" name="phone2" value="<?php echo $row1['teacherphone2'] ?>">
