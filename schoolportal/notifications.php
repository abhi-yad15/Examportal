...
$result2=mysqli_query($conn,"SELECT * FROM school_notification ORDER BY date DESC");
          ...
          <h2>Notifications:</h2><br />
               <div class="margin" style="text-align:left">
                   ...
                   while($row2 = mysqli_fetch_array($result2,MYSQLI_ASSOC)){
                       ...
                       $str= "q". $count;
                   ?>
                <li> <input id="<?php echo $total; ?>" type='submit' name='<?php echo $str; ?>' style="text-align:left;color:navy;" class="btn btn-block" value='<?php echo $row2['date']."::" . $row2['sub'] ?>' onClick="Display1(this.name,this.id)">
                <li id="<?php echo $str; ?>" class="inv"><b>:&nbsp;&nbsp;</b><?php echo $row2['description']; ?><br/></li> 
                   <?php } ?>
            </div>
      </div>
    </section>
